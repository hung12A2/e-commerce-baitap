...
?>
 ...
 <!-- Start Bradcaump area -->
        ...
        <section class="htc__product__details bg__white ptb--100">
                                ...
                                <div class="product__big__images">
                                    <div class="portfolio-full-image tab-content">
                                        <div role="tabpanel" class="tab-pane fade in active imageZoom" id="img-tab-1">
                                            <img  width="" data-origin="<?php echo PRODUCT_IMAGE_SITE_PATH.$get_product['0']['image']?>" src="https://owen.vn/media/catalog/product/cache/323c1569b2962717ca2c8faa79ff3a65/p/a/pat22512-1.jpg">
                                        </div>
			...
			echo "<img src='https://owen.vn/media/catalog/product/cache/323c1569b2962717ca2c8faa79ff3a65/p/a/pat22512-1.jpg' onclick=showMultipleImage('".PRODUCT_MULTIPLE_IMAGE_SITE_PATH.$list."')>";
											}
											?>
...
?>
									...
									<div class="category">
												<div class="ht__cat__thumb">
													<a href="product.php?id=<?php echo $list['id']?>">
														<img src="https://owen.vn/media/catalog/product/cache/323c1569b2962717ca2c8faa79ff3a65/p/a/pat22512-1.jpg" alt="product images">
													</a>
												</div>
		...
		?>
			...
			function showMultipleImage(im){
				jQuery('#img-tab-1').html("<img src='https://owen.vn/media/catalog/product/cache/323c1569b2962717ca2c8faa79ff3a65/p/a/pat22512-1.jpg'/>");
